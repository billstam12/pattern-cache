...
//      * @param datasetStart The start timestamp of the entire dataset (for relative positioning)
//      */
//     public ApproxOLSSketch(long from, long to, long datasetStart) {
//         this.from = from;
//         this.to = to;
...
//             double fromPositionRelativeToSketch = datasetStart + (dp.getFrom() - this.from) / (double) originalAggregateInterval.toDuration().toMillis();
//             double toPositionRelativeToSketch = datasetStart + (dp.getTo() - this.from) / (double) originalAggregateInterval.toDuration().toMillis();
...
//     @Override
//     public Sketch clone() {
//         ApproxOLSSketch sketch = new ApproxOLSSketch(this.from, this.to, this.datasetStart);
