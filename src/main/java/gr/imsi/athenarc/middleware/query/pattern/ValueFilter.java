...
public class ValueFilter {
     ...
     *
     * @param minDegree Minimum degree value (between -90 and 90)
     * @param maxDegree Maximum degree value (between -90 and 90)
     */
    public static ValueFilter custom(float minDegree, float maxDegree) {
        if (minDegree < -90 || minDegree > 90 || maxDegree < -90 || maxDegree > 90 || minDegree > maxDegree) {
            throw new IllegalArgumentException("Degree values must be between -90 and 90, and min must be <= max");
        }
