...
public class JDBCConnection implements DatabaseConnection {
    ...
    public DatabaseConnection connect() {
        ...
        try {
            ...
            // SSL=false is a Postgres-specific option; DuckDB and Trino reject it.
            ...
            LOG.error("Failed to open JDBC connection to {}: {}", host, e.getMessage());
            throw new RuntimeException("JDBC connect failed for " + host, e);
        }
        return this;
    }
