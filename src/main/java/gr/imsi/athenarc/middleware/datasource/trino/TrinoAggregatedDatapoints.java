...
public class TrinoAggregatedDatapoints implements AggregatedDataPoints {
    ...
    public TrinoAggregatedDatapoints(SQLQueryExecutor trinoQueryExecutor, SQLDataset dataset, long from, long to,
    ...
    private String buildDataSourceQuery(String tableName, String measureName, String timestampColumn,
        ...
        // Trino uses from_unixtime instead of to_timestamp and different syntax
    ...
    private String buildAggregateQuery(
        ...
        // Build outer select: aggregate as needed and select first/last as arbitrary from group (since they're constant per group)
    ...
    private String generateTimeBucketExpression(String timestampColumn, long intervalMillis, long offset) {
        ...
        // Work in milliseconds for precision, then convert back to timestamp
