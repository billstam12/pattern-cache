...
public class TrinoConfiguration implements DataSourceConfiguration {
    ...
    public TrinoConfiguration(String url, String username, String password, String catalog, String schemaName, String tableName,
    ...
    public static class Builder {
        ...
        public TrinoConfiguration build() {
            TrinoConfiguration config = new TrinoConfiguration();
            config.url = this.url;
            config.username = this.username;
            config.password = this.password;
            config.catalog = this.catalog;
