...
public class InfluxDBDatasource implements DataSource {
    ...
    public AggregatedDataPoints getAggregatedDataPointsWithTimestamps(long from, long to,
        ...
        return new InfluxDBTimestampedAggregatedDatapoints(influxDBQueryExecutor, dataset, from, to, missingIntervalsPerMeasure, aggregateIntervalsPerMeasure, aggregateFunctions);
    }
