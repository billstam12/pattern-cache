...
public class IntervalTree<T extends TimeInterval> implements Iterable<T>, Serializable {
    ...
    private class Node implements TimeInterval {
        ...
        public int compareTo(TimeInterval o) {
            TimeInterval other = (o instanceof IntervalTree.Node) ? ((Node) o).interval : o;
            return interval.compareTo(other);
        }
        ///////////////////////////////////
        ...
        private Node search(T t) {
            ...
            while (!n.isNil() && t.compareTo(n.interval) != 0) {
                n = t.compareTo(n.interval) == -1 ? n.left : n.right;
            }
            return n;
        }
