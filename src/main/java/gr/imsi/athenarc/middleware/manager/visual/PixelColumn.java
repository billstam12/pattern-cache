...
public class PixelColumn implements TimeInterval {
    ...
    protected void markAsNoError() {
        this.hasNoError = true;
    }

    protected void markAsHasError() {
    ...
    protected PixelColumn(long from, long to, ViewPort viewPort) {
        this.from = from;
        this.to = to;
    ...
    protected void addAggregatedDataPoint(AggregatedDataPoint dp) {
        if (dp.getFrom() <= from) {
     ...
     */
     ...
     protected Range<Integer> computeMaxInnerPixelRange(Stats viewPortStats) {
     ...
     */
    protected Range<Integer> getPixelIdsForLineSegment(double t1, double v1, double t2, double v2, Stats viewPortStats) {
     ...
     */
    protected Range<Integer> getActualInnerColumnPixelRange(Stats viewPortStats) {
    ...
    protected AggregatedDataPoint getLeftPartial() {
        return leftPartial;
    }

    protected AggregatedDataPoint getRightPartial() {
        return rightPartial;
    }

    protected List<AggregatedDataPoint> getLeft() {
        return left;
    }

    protected List<AggregatedDataPoint> getRight() {
        return right;
    }
