...
public class M4AggregateTimeSeriesSpan implements TimeSeriesSpan {
     ...
     */
    public M4AggregateTimeSeriesSpan rollUp(AggregateInterval targetInterval) {
        ...
        // Create new span
        M4AggregateTimeSeriesSpan rolledUpSpan = new M4AggregateTimeSeriesSpan(from, to, measure, targetInterval);
